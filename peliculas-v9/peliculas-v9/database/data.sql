...
('ADMIN', 'admin@example.com', '$2a$10$AGkYKySSNNJyEa5fVknrgODphGZAsri6K5nIV/iO7mzeYVCSCj36O', 'ADMIN');

INSERT INTO users (name, email, password, role) VALUES
('USER', 'user@example.com', '$2a$10$AGkYKySSNNJyEa5fVknrgODphGZAsri6K5nIV/iO7mzeYVCSCj36O', 'USER');
